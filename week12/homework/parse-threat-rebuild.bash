...
#!/bin/bash
#Storyline : Extract IPs from https://www.projecthoneypot.org/list_of_ips.php and create a fiewall ruleset

#134.119.216.167 | CR	Bad Event	214,874	2017-03-18 	2021-11-14

#wget https://www.projecthoneypot.org/list_of_ips.php -O /tmp/access.log
